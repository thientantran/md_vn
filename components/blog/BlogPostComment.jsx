...
export default function BlogPostComment() {
  return (
    <section className="mt-4">
              ...
              <article className="px-6 py-2 mb-2 text-base bg-white rounded-lg dark:bg-gray-900">
              ...
              <article className="py-2 px-6 mb-6 ml-6 lg:ml-12 text-base bg-white rounded-lg dark:bg-gray-900">
                <footer className="flex justify-between items-center mb-2">
                  <div className="flex items-center">
