  ...
  return (
    <div className="px-2 sm:px-4 md:px-6 lg:px=8 my-1 md:my-4 py-3 sm:py-6 bg-white rounded-lg shadow-md">
      <div className="flex justify-between items-center">
        <span className="text-xs md:text-sm font-light text-gray-600"><FormattedDate data={post.createdAt} /></span>
      ...
      <div className="flex justify-between items-center mt-4">
        <Link href={`/news/${post.id}`} className="text-blue-600 hover:underline text-xs md:text-sm">Read more</Link>
